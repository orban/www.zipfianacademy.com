...
---
<!-- This currently uses first person singular; we might change it to first person plural. -->
...
various contemporary data science techniques follow. We've broken it into
a few parts.

1. Store everything.
2. Anything can be quantified.
...
Relating this to the earlier point that you should store everything, here are some of the ways I think.
